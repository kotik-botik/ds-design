...
- Замеры (390×844, pravatar застаблен 1×1 PNG):
  ...
  - state-2 разлёт (commit 784f0d6, перекрывающаяся центрированная группа): крупные карты НЕ круги, а высокие rounded-rect (aspect ~0.65): Friend2 253×388 cx208/cy407 z2, Friend1 183×281 cx228/cy542 z3 (поверх всех), Friend3 155×238 cx118/cy487 z1. Декор A 90⌀ cx98/cy377, B 80⌀ cx133/cy597, C 74⌀ cx313/cy472, D 38⌀ cx183/cy637, все z1 (за крупными). Все соседние пары перекрываются по center-dist<sumR (Friend2-1 136<218, F2-3 120<204, F3-1 123<169; декоры A/B/C/D пересекают ближайший крупный). bbox L40/T213/R350/B682 → центр cx195.1/cy447.6 (vp center 195 ✓; цель cy468 от title.bottom172.8↔button.top764 — реальный 447.6, выше цели на ~20px). title.offsetTop=96, button#fpAcceptAll.top=764. Стек по скрину: F1(blue)>F2(purple)>F3(orange)>декоры(края торчат). СЭМПЛИТЬ: waitForFunction на класс `__state-2` затем waitForTimeout 2050ms (spring 2000 завершён, +50ms в PAUSE 800 — ещё state-2, до 2→3).
